...
Or, execute the latest script directly from this repository in a single command on your VPS:

```bash
curl -fsSL https://raw.githubusercontent.com/5201314xmt/13333/refs/heads/main/deploy.sh | bash
```
